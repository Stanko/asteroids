...
export function parseParamsFromSearch(search: string): AppParams {
  ...
  const parsed = normalizeParams({
    ...
    highlightAmount: parseFloatValue(url.get("ha")),
    highlightOpacity: parseFloatValue(url.get("ho")),
...
export function serializeParamsToSearch(params: AppParams): string {
  ...
  const entries: Array<[string, string]> = [
    ...
    ["ha", formatFloat(normalized.highlightAmount)],
    ["ho", formatFloat(normalized.highlightOpacity)],
